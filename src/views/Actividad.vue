    ...
    cuestionario: {
      ...
      preguntas: [
        ...
        },
        {
          id: 9,
          texto:
            'Un <em>script</em> comercial debe ser rígido y no permitir adaptaciones durante la negociación.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 10,
          texto:
            'Los <em>scripts</em> comerciales ayudan a estructurar el mensaje y anticipar objeciones del cliente.',
          imagen: require('@/assets/actividad/imagen2.png'),
          barajarRespuestas: true,
          opciones: [
            {
